...
from meiduo_admin.serializers.users import GoodVisitSerializer, UsersInfoSerializer
...
class GoodView(APIView):
    ...
    def get(self, request):
        ...
        # 获取查询集数据
        good_visit = GoodsVisitCount.objects.filter(date=now_date)
        serializer = GoodVisitSerializer(good_visit, many=True)
