from django.core.files.storage import Storage  # 继承Storage需要重写_open或_save方法
...
class FastDFSStorage(Storage):
    ...
    def __init__(self, client_conf=None, base_url=None):
        ...
        # if client_conf is None:
        #     self.client_conf = settings.DEFAULT_FILE_STORAGE
        #
        # self.client_conf = client_conf
        #
        # if base_url is None:
    ...
    def url(self, name):
        ...
        :param name: file_id
        :return: http://192.168.47.156:8888 + file_id
        """
        # return 'http://192.168.47.156:8888/' + name
